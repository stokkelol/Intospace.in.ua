            ...
            <ul class="nav navbar-nav">
                ...
                @else
                    <li class="dropdown cl-effect-17">
                        <a href="/posts" class="navbar-dropdown-menu">Обзоры<span class="caret cl-effect-1"></span></a>
                    ...
                    <li class="dropdown cl-effect-17">
                        <a href="/videos" class="navbar-dropdown-menu">Видео<span class="caret cl-effect-1"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown cl-effect-17">
                        <a href="/monthlyreviews" class="navbar-dropdown-menu">Достойно внимания<span class="caret cl-effect-1"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown cl-effect-17">
                        <a href="{{ url('categories/old-reviews') }}" class="navbar-dropdown-menu">Ностальгия</a>
                    </li>
                @endif
            </ul>
