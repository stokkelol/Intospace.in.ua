...
@else
    ...
    <meta property="og:description" content="{{ isset($post->excerpt) ? strip_tags($post->excerpt) : 'intospace.in.ua - мрак и блог, вот это вот' }}" />
    ...
    <meta name="twitter:description" content="{{ isset($post->excerpt) ? strip_tags($post->excerpt) : 'intospace.in.ua - мрак и блог, вот это вот' }}">
